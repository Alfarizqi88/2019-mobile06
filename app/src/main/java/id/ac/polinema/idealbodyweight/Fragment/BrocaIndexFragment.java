...
public class BrocaIndexFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final RadioGroup genderGroup = view.findViewById(R.id.Radio_Gender);
        final EditText heightText  = view.findViewById(R.id.extHeight);

        Button calculateButton = view.findViewById(R.id.btncalculate);
